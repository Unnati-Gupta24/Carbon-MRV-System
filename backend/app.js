...
app.listen(PORT, () => {
  ...
  console.log(`📍 Contract Address: ${blockchainModel.CONTRACT_ADDRESS || 'Not configured'}`)
  console.log(`⛓️ Blockchain: ${blockchainModel.blockchainEnabled ? 'Enabled' : 'Disabled'}`)
  console.log(`🌐 Health Check: http://localhost:${PORT}/health`)
  console.log('Ready to process blue carbon projects! 🌊🌱')
  
  if (!blockchainModel.blockchainEnabled) {
    console.log('')
